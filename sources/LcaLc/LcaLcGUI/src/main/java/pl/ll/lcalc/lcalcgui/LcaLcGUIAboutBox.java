...
public class LcaLcGUIAboutBox extends javax.swing.JDialog {

    public LcaLcGUIAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(pl.ll.lcalc.lcalcgui.LcaLcGUI.class).getContext().getResourceMap(LcaLcGUIAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(pl.ll.lcalc.lcalcgui.LcaLcGUI.class).getContext().getActionMap(LcaLcGUIAboutBox.class, this);
